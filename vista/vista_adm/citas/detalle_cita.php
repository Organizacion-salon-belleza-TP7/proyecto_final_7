...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="<?= BASE_URL ?>/controlador/controladores_adm/controlador_logout/controlador_logout.php?logout=detalle_cita">Cerrar sesión</a>
  </div>
  ...
  <div class="content" id="content">
    ...
    <div class="detalle-card">
      ...
      <div class="info-section">
        ...
        <p><strong>Hash ID:</strong> <code style="background:rgba(0,0,0,0.2);padding:2px 6px;border-radius:4px;font-size:0.85rem;">
          <?= htmlspecialchars($cita['hash_identificacion']) ?>
        </code></p>
      </div>
