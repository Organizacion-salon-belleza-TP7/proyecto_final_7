...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="<?= BASE_URL ?>/controlador/controladores_adm/controlador_logout/controlador_logout.php?logout=vista_citas"><i class="fas fa-sign-out-alt"></i> Cerrar sesión</a>
  </div>
    ...
    <div class="card">
      <?php if (!empty($resultado_citas)): ?>
        <table>
          ...
          <tbody>
            <?php foreach ($resultado_citas as $row): ?>
              <tr>
                <td>#<?= $row['id_cita'] ?></td>
                <td><?= htmlspecialchars($row['nombre_cliente'] ?? 'No asignado') ?></td>
                <td><?= htmlspecialchars($row['servicios'] ?? '-') ?></td>
                <td><?= htmlspecialchars($row['combos'] ?? '-') ?></td>
                <td><?= date('d/m/Y H:i', strtotime($row['fecha_cita'])) ?></td>
                <td class="<?= $row['activo'] ? 'activo' : 'inactivo' ?>">
                  <?= $row['activo'] ? 'Sí' : 'No' ?>
                </td>
                <td>
                  <a href="<?= BASE_URL ?>/controlador/controladores_adm/controlador_citas/CitasControlador.php?detalle=true&id=<?= $row['id_cita'] ?>" class="btn btn-detail">
                    Ver Detalle
                  </a>
                </td>
              </tr>
